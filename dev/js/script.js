...
window.onload = function () {
  ...
  function handleButtonClick(e) {
      ...
      var wrap = document.getElementById("playlist");
  ...
  function loadPlaylist() {
      ...
      var wrap = document.getElementById("playlist");
      var review = document.getElementsByClassName('good_info__review');
      if (playlistArray != null) {
          for (var i = 0; i < playlistArray.length; i++) {
              var spanName = document.createElement("span");
              var pText = document.createElement("p");
              spanName.innerHTML = playlistArray[i];
              pText.innerHTML = playlistArray[i];
              wrap.appendChild(spanName);
              wrap.appendChild(pText);
              review
              spanName.classList.add('review_name');
              pText.classList.add('review_txt');
